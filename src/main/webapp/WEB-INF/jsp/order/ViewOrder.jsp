	...
	<table>
		<tr>
			<th align="center" colspan="2">Order
				#${actionBean.order.orderId} <fmt:formatDate
					value="${actionBean.order.orderDate}" pattern="yyyy/MM/dd hh:mm:ss" />
			</th>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Status: <c:out
					value="${actionBean.order.status}" /></td>
		</tr>
		<tr>
			<td colspan="2">
				<table>
